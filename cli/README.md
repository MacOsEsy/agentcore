...
The `agentcore` CLI is the official command-line tool to manage, sync, and version-control engineering standards across all major AI agents (**Cursor, Claude Code, GitHub Copilot, Gemini, Roo Code, OpenCode, and more**).

---

## 💡 What does this tool do?

If the **AgentCore standard** is the "instruction manual" for your AI, this CLI is the **delivery truck** that brings those instructions to your project.
...
**AgentCore** solves this by treating prompt instructions as **versioned dependencies**, similar to how you manage software libraries.
